            ...
            <div className="max-w-7xl mx-auto px-6">
                <FadeIn>
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Documentation</h1>
                        <p className="text-slate-400 text-lg mb-8">
                            Everything you need to know about Captain EPM, from basic setup to advanced automation.
                        </p>
