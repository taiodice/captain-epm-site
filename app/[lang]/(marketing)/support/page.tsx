            ...
            <div className="max-w-7xl mx-auto px-6">
                <FadeIn>
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">{dictionary.support.title}</h1>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    <FadeIn delay={0.1}>
                        <Card className="p-8 text-center h-full">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{dictionary.support.kb}</h3>
                            <p className="text-slate-400 mb-6">{dictionary.support.kb_desc}</p>
                            <Button variant="secondary" className="w-full">{dictionary.support.kb_btn}</Button>
                        </Card>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.2}>
                        <Card className="p-8 text-center h-full">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{dictionary.support.community}</h3>
                            <p className="text-slate-400 mb-6">{dictionary.support.community_desc}</p>
                            <Button variant="secondary" className="w-full">{dictionary.support.community_btn}</Button>
                        </Card>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.3}>
                        <Card className="p-8 text-center h-full">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">{dictionary.support.chat}</h3>
                            <p className="text-slate-400 mb-6">{dictionary.support.chat_desc}</p>
                            <Button variant="secondary" className="w-full">{dictionary.support.chat_btn}</Button>
                        </Card>
                    </FadeIn>
                </div>
                ...
                <FadeIn delay={0.4}>
                    <div className="bg-gradient-to-r from-surface to-surface-light p-8 md:p-12 rounded-3xl border border-white/5 text-center">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-4">{dictionary.support.still_need_help}</h2>
                        <p className="text-slate-400 mb-8 max-w-xl mx-auto">
                            Our dedicated support team is available 24/5 to assist with complex issues and technical inquiries.
                        </p>
                        <div className="flex justify-center gap-4">
                            <Button variant="primary" size="lg">{dictionary.support.contact_support}</Button>
